...
class LoadDataClass:
    ...
    def readHadCutData(self):
        ...
        self.sourceDataSnippet = pd.read_csv("./CanConstruct/src/HadCutData/" + str(doc1Num) + ".csv", index_col=0)
        self.historyNormalDataSnippet = pd.read_csv("./CanConstruct/src/HadCutData/" + str(doc2Num) + ".csv", index_col=0)
